    ...
    return(
        <div className="Section">
            <div className="dastavka">
                ...
                <p className="p_dastavka">Toshkent shahar ichida yetkazib berish bepul(shahar tashqarisida yetkazib berish alohida to'lanadi)</p>
                </div>
                <button className="btn_section_1">Buyurtma berish</button>
           </div>
            ...
            <div className="imgSection">
               ...
               <div className="imgP">
                   <h1>Tajriba</h1>
                   <p className="Xodimlarimizning_profisionalligi">Xodimlarimizning profisionalligi</p>
               </div>
               </div>
               ...
               <div className="imgP">
                   <h1 className="Xodimlarimizning_profisionalligiCarh1">Yetkazib berish</h1>
                   <p className="Xodimlarimizning_profisionalligiCar">Shahar ichida bepul yetkazib berish</p>
               </div>
               </div>
               ...
               <div className="imgP">
                   <h1>Sifat</h1>
                   <p className="Xodimlarimizning_profisionalligi">Mustahkam sifatli baseynlar</p>
               </div>
               </div>
            ...
            <div className="information_intex">
                ...
                <div className="information_2">
                    ...
                    <div className="information_checkout">
                      ...
                      <li className="information_li">  <img src="./image/checkout.svg"/> <p className="information_li_p">Chidam</p></li>
                        </ul>
                    </div>
                    <div className="information_checkout">
                        <ul className="information_ul">
                      <li className="information_li">  <img src="./image/checkout.svg"/> <p className="information_li_p">O'rnatish uchun arzon</p></li>
                        </ul>
                    </div>
                    <div className="information_checkout">
                        <ul className="information_ul">
                      <li className="information_li">  <img src="./image/checkout.svg"/> <p className="information_li_p">Chiroyli va yorqin ranglar</p></li>
                        </ul>
                    </div>
                    <div className="information_checkout">
                        <ul className="information_ul">
                      <li className="information_li">  <img src="./image/checkout.svg"/> <p className="information_li_p">Zamonaviy dizayn</p></li>
                        </ul>
                    </div>
                    <div className="information_checkout">
                        <ul className="information_ul">
                      <li className="information_li">  <img src="./image/checkout.svg"/> <p className="information_li_p">Yuqori sifat</p></li>
                        </ul>
                    </div>
                </div>
            </div> 
